...
Page({
  ...
  bindCheckout: function () {
    ...
    wx.navigateTo({
      url: '/pages/checkout/checkout?cartIds=' + cartIds + '&amount=' + this.data.total
    });
  },
  getCarts: function () {
    var minusStatuses = [];
    ...
    app.server.getJSON('/Cart/cartList/session_id/' + app.globalData.openid, { user_id: user_id }, (res) => {
  ...
  deleteCart: function (e) {
    ...
    var that = this
    app.server.getJSON('/Cart/delCart/id/' + id, function (res) {
      that.getCarts();
    });
  },
  saveNum: function (id, num) {
    app.server.getJSON('/Cart/updateNum/id/' + id + "/num/" + num, (res) => {
      this.getCarts();
    });
  },
  updataSelect: function (id, selected) {
    ...
    app.server.getJSON('/Cart/updateSelect/id/' + id + "/selected/" + selected, function (res) {
  ...
  updateAllSelect: function (id, selected) {
    ...
    app.server.getJSON('/Cart/updateAllSelect/open_id/' + id + "/selected/" + selected, function (res) {
