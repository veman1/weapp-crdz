...
district = this.data.district
    ...
    app.server.postJSON('/User/editAddress/user_id/' + user_id + "/address_id/" + address_id,{user_id:user_id,mobile:mobile,zipcode:zipcode,consignee:consignee,address:address,is_default:is_default,country:country,twon:twon,province:province,city:city,district:district,address_id:address_id},function(res){
  ...
  onLoad: function (options) {
	...
	loadAddress: function (options) {
      ...
      app.server.getJSON('/User/get_address/user_id/' + user_id + "/id/" + options.objectId,function(res){
