...
Page({
  ...
  formSubmit: function (e) {
    ...
    console.log('getApp is ' ,getApp().globalData);
    ...
    console.log("data is ", this.data.provinceIndex);
    console.log("data is ", this.data.cityIndex);
    console.log("data is ", this.data.regionIndex);
    if (this.data.provinceIndex != undefined && this.data.cityIndex != undefined && this.data.regionIndex != undefined ){
      ...
      var that = this;
      app.server.postJSON('/User/addAddress/user_id/' + user_id, { user_id: user_id, mobile: mobile, zipcode: zipcode, consignee: consignee, address: address, is_default: is_default, country: country, twon: twon, province: province, city: city, district: district }, function (res) {
  ...
  getArea: function (pid, cb) {
    ...
    app.server.getJSON('/User/getArea/parent_id/' + pid, function (res) {
      cb(res.data.result);
    })
  },
